    ...
    <div className="min-h-screen w-screen flex flex-col justify-around items-center gap-8 relative py-24 px-8 overflow-x-hidden">
      ...
      <div>
        ...
        <AnimatedText
          el="h2"
          text="Devesh Sharma"
          className="font-sans text-4xl md:text-5xl uppercase"
          once
        />
      </div>
      ...
      <div>
        <AnimatedText
          ...
          once
        />
        <span className="text-xl md:text-5xl uppercase" ref={typedRef}></span>
      </div>
      <motion.a
        className="lg:absolute left-5 bottom-5 my-auto h-fit bg-yellow-400 p-4 
        lg:rounded-full rounded-lg justify-center items-center lg:flex-col gap-4 lg:w-14 flex lg:top-5 "
        href="/Resume.pdf"
        {...resumeDownloadAnimation}
      >
      ...
      <motion.div
        className="lg:absolute right-5 lg:top-5 bottom-5 my-auto h-fit bg-yellow-400 px-2 py-2 lg:py-6
