  ...
  const handleImageInputChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (url) {
        ...
        const editorElement = document.querySelector('.EasyMDEContainer')?.querySelector('.CodeMirror');
      ...
      <form onSubmit={handleSave} className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-2">
            <label htmlFor="title" className="text-yellow-400 font-semibold">Title</label>
            <input
              type="text"
              id="title"
              value={title}
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="subtitle" className="text-yellow-400 font-semibold">Subtitle</label>
          <input
            type="text"
            id="subtitle"
            value={subtitle}
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="content" className="text-yellow-400 font-semibold">Content (Markdown)</label>
        ...
        <div className="flex gap-4 justify-end mt-4">
          ...
          >
            {saving || uploading ? 'Saving...' : isEdit ? 'Update Post' : 'Create Post'}
          </button>
        </div>
      </form>
    </div>
